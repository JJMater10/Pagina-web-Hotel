...
(1, 'admin', 25, 9887532, 123456789, '0'),
(3, 'prueba', 29, 9876, 987654321, 'prueba@gmail.com');
...
(1, '2025-03-25', '2025-03-28', 1, 1, 1, NULL),
...
ALTER TABLE `hospedaje`
  ...
  ADD UNIQUE KEY `estado_hab_idestado_hab` (`estado_hab_idestado_hab`),
